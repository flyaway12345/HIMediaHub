...
index:number = 1;
  pokemonEndpoint = this.pokeAPI.getPokemonFromPokeAPIURL + this.index;
  ...
  getData(){
    for(let i = 0; i < 5; i++){
      this.index = i;
      this.pokemonEndpoint = this.pokeAPI.getPokemonFromPokeAPIURL + (this.index+1);
      console.log(this.pokemonEndpoint);
      this.pokeAPI.getData(this.pokemonEndpoint).subscribe(data=>this.pokemonData=data);
      this.pokemonDataArray[i] = this.pokemonData;
